...
public class M2 implements Idetificate, Serializable {
    private int id;
    private String name;
    ...
    public M2(int id, String name, String capacity, String writing_speed, String reading_speed, String price, String dns, byte[] image) {
        this.id = id;
        this.name = name;
